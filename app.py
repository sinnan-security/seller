...
@app.route('/api/seller/SomeRoute', methods=['GET'])
@app.route('/api/seller/SomeRoute', methods=['POST'])
@app.route('/api/seller/SomeRoute', methods=['PUT'])
@app.route('/api/seller/SomeRoute', methods=['DELETE'])
def SomeFunctionality():
	response={}
	logger(request,response)
	return "<h1>seller service %s</H1>"%(rand)
	
@app.route('/api/seller/OtherRoute', methods=['POST'])
